...
const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ 
    ...
    const variants = {
      ...
      glass: 'bg-gray-900 bg-opacity-30 backdrop-blur-sm border border-gray-700'
    }
...
export const CardTitle = forwardRef<HTMLHeadingElement, HTMLAttributes<HTMLHeadingElement>>(
  ({ className = '', children, ...props }, ref) => (
    <h3 ref={ref} className={`font-caveat font-bold text-xl lg:text-2xl text-foreground mb-2 ${className}`} {...props}>
      {children}
    </h3>
  )
)
...
export const CardDescription = forwardRef<HTMLParagraphElement, HTMLAttributes<HTMLParagraphElement>>(
  ({ className = '', children, ...props }, ref) => (
    <p ref={ref} className={`font-raleway text-gray-300 text-sm lg:text-base ${className}`} {...props}>
      {children}
    </p>
  )
)
...
export const CardFooter = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className = '', children, ...props }, ref) => (
    <div ref={ref} className={`mt-6 pt-4 border-t border-gray-700 ${className}`} {...props}>
      {children}
    </div>
  )
)
