  ...
  return (
    <Card variant='elevated'>
      <CardContent>
        ...
        {Object.entries(selectedServices).filter(([, quantity]) => quantity > 0).length > 0 && (
          <div className='mt-8'>
            <Card variant='elevated' className='border-accent-3 border-opacity-30'>
              <CardContent>
                  ...
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      ...
                      <p className='font-raleway text-gray-400 text-sm'>
                        {Object.entries(selectedServices).filter(([, quantity]) => quantity > 0).length} {Object.entries(selectedServices).filter(([, quantity]) => quantity > 0).length === 1 ? 'servicio' : 'servicios'} agregados
                      </p>
                    </div>
                  </div>
                  
                  <div className='text-right'>
                    <p className='font-raleway text-gray-400 text-sm'>Total servicios adicionales</p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className='flex items-center space-x-4'>
                          ...
                          <div className='flex items-center space-x-2'>
                            <button
                              onClick={() => onServiceUpdate(serviceId, quantity - 1)}
                              className='w-8 h-8 bg-gray-700 hover:bg-red-600 rounded-full flex items-center justify-center transition-colors duration-200'
                              aria-label='Disminuir cantidad'
                            >
                              <Minus className='w-4 h-4 text-white' />
                          ...
                          <div className='text-right min-w-[100px]'>
                            <p className='font-raleway text-gray-400 text-xs'>Subtotal</p>
