...
const services = [
  {
    ...
    features: ["Primer piso: 150 personas", "Ambos pisos: 250 personas", "Estacionamiento gratuito"],
    price: "Desde $4,000",
  ...
  },
  {
    ...
    features: ["Sonido profesional", "Luces de ambiente", "Música personalizada"],
    price: "$2,700",
    href: "/servicios#dj"
  },
  {
  ...
  },
  {
    ...
    features: ["Diseño personalizado", "Dulces variados", "Decoración temática"],
    price: "Desde $3,500",
  ...
  },
  {
    ...
    features: ["Inflable con alberca", "Trampolín grande", "Supervisión incluida"],
    price: "Desde $1,000",
  ...
  },
  {
    ...
    features: ["Personal de servicio", "Vajilla completa", "Bebidas disponibles"],
    price: "Variable",
            ...
            <CardContent className="h-full flex flex-col">
              ...
              <ul className="space-y-2 mb-6">
                {service.features.map((feature, idx) => (
                  <li key={idx} className="flex items-center text-gray-400 font-raleway text-sm">
      ...
      <div className="text-center mt-16">
        <div className="bg-gradient-to-r from-accent-3 to-accent-2 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-background text-opacity-90 font-raleway text-lg mb-8 max-w-2xl mx-auto">
            Combina nuestros servicios y crea el paquete perfecto para tu evento. 
