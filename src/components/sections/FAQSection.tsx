...
const faqs = [
  {
    ...
    answer: "Nuestro salón tiene capacidad para hasta 150 personas en el primer piso y hasta 250 personas utilizando ambos pisos. Podemos adaptarnos a eventos de diferentes tamaños para garantizar comodidad y elegancia."
  },
  {
    id: 2,
    category: "booking",
    question: "¿Cómo es el proceso de reservación?",
    answer: "El proceso es muy sencillo: 1) Selecciona los servicios que deseas, 2) Verificamos disponibilidad de fecha, 3) Firma del contrato con 50% de anticipo, 4) El 50% restante se paga hasta un día antes del evento."
  },
  {
    id: 3,
    category: "services",
    question: "¿Qué incluye la renta básica del salón?",
    answer: "La renta básica incluye el uso del espacio, mesas y sillas básicas, acceso desde la hora que necesites (incluso días previos para decoración), estacionamiento gratuito en la calle, y uso hasta las 2:00 AM."
  },
  {
    id: 4,
    category: "pricing",
    question: "¿Cuánto cuesta agregar horas extras?",
    answer: "Si tu evento necesita extenderse más allá de las 2:00 AM, el costo de horas extras es de $250 pesos por hora adicional. Te recomendamos confirmar esto al momento de la contratación."
  },
  {
    id: 5,
    category: "policies",
    question: "¿Cuál es la política de cancelación?",
    answer: "Entendemos que los planes pueden cambiar. Manejamos políticas flexibles según el tiempo de anticipación. Para conocer los detalles específicos de cancelación y reembolsos, contáctanos directamente."
  },
  {
    id: 6,
    category: "services",
    question: "¿Puedo traer mi propio DJ o debo contratar el suyo?",
    answer: "¡Tienes total flexibilidad! Puedes traer tu propio DJ o contratar nuestro servicio profesional de DJ con sonido y luces por $2,700 pesos (5 horas). Nuestro equipo cuenta con experiencia en todo tipo de eventos."
  }
]
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="font-raleway text-gray-300 mb-8 max-w-2xl mx-auto">
            Nuestro equipo está listo para resolver todas tus dudas y ayudarte a planear el evento perfecto.
          </p>
