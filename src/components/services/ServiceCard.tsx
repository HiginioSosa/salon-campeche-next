      ...
      <CardContent className="h-full flex flex-col">
        ...
        <div className="mb-4">
          <div className="flex items-baseline space-x-2">
            <span className={`font-caveat font-bold text-2xl lg:text-3xl ${
          ...
          <div className="flex-1 mb-6">
            ...
            <ul className="space-y-2">
              {service.features.map((feature, index) => (
                <li key={index} className="flex items-center space-x-2 text-gray-300 font-raleway text-sm">
      ...
      <div className="text-center mb-12">
        {icon && (
          <div className="w-16 h-16 bg-accent-3 bg-opacity-20 rounded-xl flex items-center justify-center mx-auto mb-4">
            <div className="text-accent-3 text-2xl">
              {icon}
            </div>
          </div>
        )}
