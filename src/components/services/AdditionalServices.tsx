...
const additionalServices: AdditionalService[] = [
  {
    ...
    description:
      'Servicio de taquiza con guisados variados, tortillas calientes y agua fresca',
    category: 'food',
    pricing: 'quote',
    examples: [
  ...
  },
  {
    ...
    description:
      'Servicio de buffet con variedad de platillos principales, guarniciones y postres',
    category: 'food',
    pricing: 'quote',
    examples: [
  ...
  },
  {
    ...
    description:
      'Servicio de fotografía profesional para capturar los mejores momentos',
  ...
  },
  {
    ...
    description:
      'Animadores profesionales para entretener a los niños durante el evento',
    category: 'entertainment',
    pricing: 'hourly',
    basePrice: 800,
    unit: 'hora',
  ...
  },
  {
    ...
    description:
      'Decoración personalizada según el tema específico de tu evento',
    category: 'decoration',
    pricing: 'custom',
    examples: [
  ...
  },
  {
    ...
    description:
      'Arreglos florales naturales para centros de mesa y decoración',
    category: 'decoration',
    pricing: 'quote',
    examples: [
      'Flores frescas',
  ...
  },
  {
    ...
    description:
      'Personal de seguridad para eventos grandes y garantizar tranquilidad',
    category: 'staff',
    pricing: 'hourly',
    basePrice: 300,
  ...
  },
  {
    ...
    name: 'Valet Parking',
    description:
      'Servicio de valet parking para mayor comodidad de tus invitados',
    category: 'staff',
    pricing: 'hourly',
    basePrice: 200,
...
export default function AdditionalServices() {
  ...
  const categorizeServices = () => {
    const categories = {
      ...
      entertainment: additionalServices.filter(
    ...
    <div className='space-y-12'>
      <div className='text-center'>
        ...
        <p className='font-raleway text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed'>
          Complementa tu evento con servicios especializados que harán la
          diferencia. Cada servicio se cotiza según tus necesidades específicas.
        </p>
      ...
      <div className='bg-gray-900 bg-opacity-30 rounded-xl p-6 backdrop-blur-sm'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-raleway text-gray-300'>
          <div>
            ...
            <p>• Los servicios por horas tienen un mínimo de contratación</p>
          </div>
          <div>
            <p className='mb-2'>
            ...
            <p>• Disponibilidad sujeta a fecha del evento</p>
          </div>
        </div>
      </div>
    </div>
