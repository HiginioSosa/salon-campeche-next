    ...
    <div className='space-y-8'>
      <div className='text-center'>
        ...
        <p className='font-raleway text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed'>
          Combinaciones probadas que nuestros clientes aman. Ahorra tiempo y
          dinero con nuestros paquetes prediseñados.
        </p>
            ...
            <CardContent className='h-full flex flex-col'>
              ...
              <div className='flex-1 mb-6'>
                ...
                <ul className='space-y-2'>
                  {getPackageServices(pkg.includedServices).map(
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mt-12'>
        <div className='text-center'>
          ...
          <p className='font-raleway text-gray-300 text-sm'>
            Los paquetes incluyen descuentos especiales comparado con servicios
            individuales
          </p>
        </div>
        ...
        <div className='text-center'>
          ...
          <p className='font-raleway text-gray-300 text-sm'>
            Un solo contrato, un solo pago, coordinación completa de todos los
            servicios
          </p>
        </div>
